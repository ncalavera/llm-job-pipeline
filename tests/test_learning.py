...
Absorbed tests/test_auto_garbage.py — the strong model's near-zero scores
seeding filter proposals automatically, still gated by the recurrence
...
# run a command, so the whole ledger holds a handful. Now that every role gets
# one strong-model pass (no cheap screen), a near-zero score is a considered
# judgement and can do that work automatically — without loosening any guard.
# ===========================================================================
