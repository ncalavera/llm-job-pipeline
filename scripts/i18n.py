...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "boards_live_note": "Total and fresh-14d vacancy counts come from the live API.",
        "boards_col_yield": "Yield (your history)",
        "boards_yield_scored": "scored",
        "boards_yield_fit": "fit",
        "boards_yield_liked": "liked",
        ...
        "vac_status_declined": "Declined",
        "vac_status_accepted": "Accepted",
        ...
        # --- Triage: Board | Table -------------------------------------
        "triage_view_label": "Triage view",
        "triage_view_board": "Board",
        "triage_view_table": "Table",
        # --- Applications table ----------------------------------------
        ...
        "apps_count_waiting": "waiting",
        "apps_count_in_progress": "in progress",
        "apps_count_accepted": "accepted",
        "apps_count_declined": "declined",
    ...
    "ru": {
        ...
        "vac_status_declined": "Отказ",
        "vac_status_accepted": "Приняли",
        ...
        # --- Триаж: Доска | Таблица -------------------------------------
        "triage_view_label": "Вид триажа",
        "triage_view_board": "Доска",
        "triage_view_table": "Таблица",
        # --- Таблица заявок ---------------------------------------------
        ...
        "apps_count_in_progress": "в работе",
        "apps_count_accepted": "приняли",
        ...
        "contact_status_planned": "В плане",
        "contact_status_contacted": "Написал",
        "contact_status_replied": "Ответили",
        "contact_status_met": "Поговорили",
        "contact_status_declined": "Отказ",
        "contact_status_stale": "Затихло",
        ...
        "today_liked": "В избранном — решить",
        ...
        "boards_live_note": "Всего вакансий и свежих за 14д — из живого API.",
        "boards_col_yield": "Отдача (по твоей истории)",
        "boards_yield_scored": "оценено",
        "boards_yield_fit": "подходит",
        "boards_yield_liked": "нравится",
...
STRINGS["en"].update(
    {
        ...
        "screen_review_title": "Review a few roles together",
        "screen_roles": "roles",
        ...
        "digest_daily_screening": "Daily screening: {new} new arrivals\n"
        "Ready to review: {ready}\n"
        "Awaiting preparation: {waiting}\n"
        "Preparation failed, retry next run: {failed}",
        ...
        "digest_open_screening": "Open screening",
    }
)
...
STRINGS["ru"].update(
    {
        ...
        "digest_daily_screening": "Ежедневный разбор: {new} новых вакансий\n"
        "Готовы к просмотру: {ready}\n"
        "Ожидают подготовки: {waiting}\n"
        "Ошибка подготовки, повтор в следующем запуске: {failed}",
        ...
        "следующем запуске.",
        "digest_open_screening": "Открыть разбор",
    }
)
...
STRINGS["en"].update(
    {
        ...
        "summary_unit_note": "one role can arrive as several vacancies — the same job listed in more than "
        "one place. Sources send vacancies; roles are what gets scored",
...
STRINGS["ru"].update(
    {
        ...
        "summary_unit_note": "одна роль может прийти несколькими вакансиями — та же работа, размещённая в "
        "разных местах. Источники присылают вакансии, а оцениваем мы роли",
