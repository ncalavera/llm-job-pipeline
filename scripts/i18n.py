...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "health_manual_summary": "{n} companies have no direct fetch but are covered by boards or tracked by hand — not broken",
        ...
        "health_offline": "This view needs the live API (it reads current pipeline state, never baked). Open the hosted dashboard, or run the local server.",
        ...
        "health_diagram_offline": "Architecture diagram needs the Mermaid CDN (offline?). See docs/ARCHITECTURE.md.",
        "tab_health": "Health",
        "health_title": "Health",
        "health_sub": "What works, what's broken, what waits on you, and whether your verdicts changed anything.",
        ...
        "btn_review": "Review",
        "btn_approve": "Select company",
        "btn_reject": "Block company",
        # Company profile reorg (U7)
        "cp_review_pending": "Not selected",
        "cp_review_approved": "Selected",
        "cp_review_archived": "Excluded",
        "cp_archive": "Stop tracking",
        "cp_restore": "Unblock and select",
        ...
        # Screen view (bulk screening inbox)
        "screen_tab": "Inbox",
    ...
    "ru": {
        ...
        "health_manual_summary": "Компаний без прямого сбора: {n}. Их вакансии ищем на досках или проверяем вручную — это не ошибка.",
        ...
        "health_offline": "Для этого экрана нужны свежие данные с сервера. Откройте размещённую версию или запустите локальный сервер.",
        ...
        "health_diagram_offline": "Не удалось загрузить схему. Проверьте соединение; текстовое описание — в docs/ARCHITECTURE.md.",
        "tab_health": "Состояние",
        "health_title": "Состояние",
        "health_sub": "Что работает, где ошибки, что ждёт вашего решения и что изменилось после ваших оценок.",
        ...
        "btn_review": "Ревью",
        "btn_approve": "Выбрать компанию",
        "btn_reject": "Заблокировать компанию",
        # Company profile reorg (U7)
        "cp_review_pending": "Не выбрана",
        "cp_review_approved": "Выбрана",
        "cp_review_archived": "Исключена",
        "cp_archive": "Не отслеживать",
        "cp_restore": "Разблокировать и выбрать",
...
STRINGS["en"].update(
    {
        ...
        "screen_other": "Other",
        # Daily review screen (Direction B). The batch header, the per-role
        # suggestion pill, the short conflict phrase and the undo toast.
        "review_batch": "Batch",
        "review_model_default": "Model default:",
        "review_accept_batch": "Accept defaults for batch",
        "review_unsure": "Unsure",
        "review_no_conflict": "No conflict found",
        "review_no_default": "no suggestion",
        "review_undone": "Undone",
        "review_deadline_none": "no deadline",
        "review_deadline_today": "today",
        "review_deadline_passed": "passed",
        "review_nearest_none": "no deadline ahead",
        "review_nearest_today": "nearest deadline today",
        "review_nearest_in": "nearest deadline in {n}",
        "review_days": "{n} days",
        "review_one_day": "1 day",
        "screen_required": "Required",
        "screen_preferred": "Preferred",
        "screen_finding": "Fit",
...
STRINGS["ru"].update(
    {
        ...
        "screen_last_seen": "Последний раз видна",
        ...
        "screen_other": "Другое",
        # Экран ежедневного разбора (направление B).
        "review_batch": "Группа",
        "review_model_default": "Совет модели:",
        "review_accept_batch": "Принять советы для группы",
        "review_unsure": "Не уверен",
        "review_no_conflict": "Конфликтов не найдено",
        "review_no_default": "без совета",
        "review_undone": "Отменено",
        "review_deadline_none": "без срока",
        "review_deadline_today": "сегодня",
        "review_deadline_passed": "срок прошёл",
        "review_nearest_none": "ближайшего срока нет",
        "review_nearest_today": "ближайший срок сегодня",
        "review_nearest_in": "ближайший срок через {n}",
        "review_days": "{n} дн.",
        "review_one_day": "1 день",
        "screen_required": "Обязательно",
        "screen_preferred": "Желательно",
