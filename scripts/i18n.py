...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "vac_back": "Back",
        "vac_move_to_apply": "Prepare application",
        "vac_like": "Keep",
        "vac_pass": "Pass",
        ...
        "vac_status_liked": "Kept",
        "vac_status_passed": "Passed",
        "vac_status_to_apply": "Prepare application",
        "vac_status_to_research": "Research company",
        "vac_status_to_network": "Contact someone",
        ...
        "app_status_offer": "Offer received",
        "app_status_rejected": "Rejected by employer",
...
STRINGS["en"].update(
    {
        ...
        "vac_status_test_task": "Test task",
        "vac_status_interview": "Interview",
        "vac_status_declined": "Rejected by employer",
        "vac_status_accepted": "Offer received",
        ...
        "apps_empty": "Nothing sent yet. Move a role to Applied on the board, or add a non-job "
        "application with `vac add`.",
        "tab_reports": "Reports",
        ...
        "reports_unavailable": "Reports need the dashboard server — they are not part of the offline "
        "snapshot.",
        ...
        "contacts_unavailable": "Networking needs the dashboard server — it is not part of the offline "
        "snapshot.",
...
STRINGS["ru"].update(
    {
        ...
        "apps_empty": "Пока ничего не отправлено. Перенесите вакансию в «Отправлено» на доске или "
        "добавьте заявку командой `vac add`.",
        "tab_reports": "Отчёты",
...
STRINGS["en"].update(
    {
        "progress_empty": "Keep a vacancy in Inbox to choose your next step here.",
...
STRINGS['en'].update({'vac_status_liked': 'Backlog', 'vac_status_to_apply': 'In progress', 'vac_status_to_research': 'In progress', 'vac_status_to_network': 'In progress', 'vac_status_test_task': 'Interviewing', 'vac_status_interview': 'Interviewing', 'screen_keep': 'Like', 'screen_list_kept': 'Liked', 'vac_like': 'Like', 'concepts_decision': 'Decision: Undecided / Like / Pass. Liked vacancies enter Backlog. Research, contacting people and drafting all belong to In progress.', 'concepts_application': 'Progress: Backlog / In progress / Applied / Interviewing / Offer or invitation / Rejected / Passed. Test tasks are part of Interviewing. Availability and submission history remain separate.', 'vac_status_declined': 'Rejected', 'vac_status_accepted': 'Offer / invitation', 'vac_move_to_apply': 'In progress'})

STRINGS['ru'].update({'vac_status_liked': 'Бэклог', 'vac_status_to_apply': 'В работе', 'vac_status_to_research': 'В работе', 'vac_status_to_network': 'В работе', 'vac_status_test_task': 'Отбор', 'vac_status_interview': 'Отбор', 'screen_keep': 'Нравится', 'screen_list_kept': 'Понравились', 'vac_like': 'Нравится', 'concepts_decision': 'Решение: Не решено / Нравится / Пропустить. Понравившиеся вакансии попадают в бэклог. Изучение, контакты и подготовка отклика — всё в работе.', 'concepts_application': 'Прогресс: Бэклог / В работе / Отклик отправлен / Отбор / Оффер или приглашение / Отказ / Пропущено. Тестовые входят в отбор. Доступность вакансии и история отправки хранятся отдельно.', 'vac_status_declined': 'Отказ работодателя', 'vac_status_accepted': 'Получен оффер', 'vac_move_to_apply': 'Подготовить отклик'})
