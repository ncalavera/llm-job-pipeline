...
- **Supabase free tier:** до 500 МБ БД и 2 ГБ трафика в месяц. Хватает
  на ~5000 вакансий с описаниями.
- **Anthropic Claude Opus:** ~$0.02 за скор одной вакансии (зависит от
  длины описания). 100 вакансий ≈ $2.
- **Firecrawl:** опционально. Free tier даёт 500 скрэйпов в месяц.
- **Vercel:** бесплатно для одного личного проекта.
